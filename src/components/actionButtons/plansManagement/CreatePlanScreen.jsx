    ...
    return (
        <ModalBase isOpen={isOpen} onClose={onClose}>
            <form onSubmit={handleSubmit(onSubmit)}>
                <EditableContainer>
                    <PlanNameInput {...register("name", { required: true })} placeholder="Nome do Plano" />
                </EditableContainer>
                ...
                <EditableContainer>
                    ...
                    <EditableInput {...register("service_quota", { required: true })} />
                </EditableContainer>
                {errors.service_quota && <span>A cota de serviço é obrigatória</span>}

                <EditableContainer>
                    <Label>Validade:</Label>
                    <EditableInput {...register("expires_in", { required: true })} />
                </EditableContainer>
